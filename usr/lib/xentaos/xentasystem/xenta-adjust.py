...
TIMESTAMPS = "/var/log/xentasystem.timestamps"
...
class XentaSystem():
    ...
    def __init__(self):
        ...
        self.logfile = open("/var/log/xentasystem.log", "w")
        self.time_log("xentaSystem started")
        self.executed = []
        self.overwritten = []
        self.skipped = []
        self.edited = []
    ...
    def adjust(self):
        try:
            ...
            try:
                ...
                config.read('/etc/xentaos/xentasystem.conf')
                ...
                with open('/etc/xentaos/xentasystem.conf', 'w') as configfile:
            ...
            adjustment_directory = "/etc/xentaos/adjustments/"
